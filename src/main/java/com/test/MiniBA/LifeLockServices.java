...
/*	public static WebDriver getdriver(){
	...
	@Test(priority=3, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "enrollment"})
...
//						}
	...
	@Test(priority=4, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "enrollment", "miniBA"})
	...
	@Test(priority = 5, dependsOnMethods={"A_SignUpSignIn", "CA_postEnrollment"}, groups = {"all", "enrollment"})
	public static void CB_ID_Theft_Dashboard() throws IOException, InterruptedException {
		...
		try {
			...
			if(text1.equalsIgnoreCase("Enroll Now")) {
				...
				if(no_of_tab>0) {		
					screenshot("ID_Theft_Dashboard_Tab_" + uniqueID);
	...
	@Test(priority = 6, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "enrollment"})
	...
	@Test(priority=7, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "miniBA", "enrollment"})
	...
	@Test(priority=8, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "miniBA", "enrollment"})
	...
	@Test(priority=9, dependsOnMethods={"A_SignUpSignIn"}, groups = {"all", "miniBA"})
